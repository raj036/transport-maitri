...
const FrameComponent1: FunctionComponent<FrameComponent1Type> = ({
  ...
  const handleNavigate = () => {
    navigate("/arrival", { state: { type: "arrival" } });
  };
    ...
    <>
      ...
      >
        ...
        <div className="self-stretch flex-1 [backdrop-filter:blur(40px)] rounded-mini [background:linear-gradient(100.87deg,_#39475b,_#c846a0)] flex flex-col items-start justify-start py-5 px-[23px] box-border relative max-w-full z-[1]">
          ...
          <b className=" relative tracking-[0.06px] leading-[13px] inline-block z-[2]">
            Arrival
          </b>
      ...
      <div className="self-stretch flex flex-row items-start justify-center py-0 pl-6 pr-5">
        <button
          onClick={logout}
          className="cursor-pointer mt-11 [border:none] py-[14px] px-[50px] bg-[transparent] shadow-[0px_4px_4px_rgba(0,_0,_0,_0.25)] rounded-mini [background:linear-gradient(90deg,_#2a8dfe,_#7545ff)] flex flex-row items-start justify-start z-[1]"
        >
          ...
          <b className="relative text-[16px] tracking-[0.06px] leading-[13px] inline-block font-inter text-white text-center min-w-[66px] z-[2]">
            Logout
          </b>
        </button>
      </div>
